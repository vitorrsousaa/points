		...
		>
			<div className="mx-auto max-w-[85rem] px-6 lg:px-8">
				<div className="mx-auto mb-8 max-w-2xl text-center lg:mb-14">
					...
					<h2 className="text-4xl font-medium tracking-tighter text-gray-800 dark:text-gray-200 md:text-5xl">
						<span className="bg-gradient-to-tl font-bold from-primary to-orange-600 bg-clip-text text-transparent">
							Economize{" "}
						</span>
						horas de tarefas repetitivas
					</h2>
				</div>

				<div className="relative xl:mx-auto xl:w-8/12">
					{/**<!-- Grid --> */}
					<div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
						...
						<Card
							label="MAIS VENDIDO"
							title="Premium"
							description="Ideal para você que quer aproveitar todos os benefícios da GRYPP no seu dia a dia do seu negócio."
							price={49}
							benefits={[
								"Cadastre até 200 atletas",
								"Crie exercícios personalizados",
								"Feedback personalizado",
								"Suporte preferêncial",
							]}
							mostPopular
						/>
					</div>
					...
					<div className="mt-7">
						<div className="absolute end-0 top-0 hidden translate-x-16 translate-y-16 md:block">
							<svg
								...
								role="img"
								aria-label="Polygonal background"
								aria-labelledby="polygonal-background"
							>
								<path
						...
						<div className="absolute bottom-0 start-0 hidden -translate-x-16 translate-y-16 md:block">
							<svg
								className="h-auto w-56 text-gray-500"
								width="347"
								height="188"
								viewBox="0 0 347 188"
								fill="none"

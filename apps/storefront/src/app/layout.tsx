...
export const metadata: Metadata = {
	...
	description:
		"Uma nova plataforma simplificada para acompanhamentos. Organize alunos, personalize treinos, colete feedbacks, tudo em um só lugar.",
	keywords: [
		"aplicativo de personal trainer",
		"site personal trainer",
		"app de personal trainer",
		"melhor app para personal trainer",
		"powerlifting",
		"site para montar treino de musculação",
		"site de treinos",
	],

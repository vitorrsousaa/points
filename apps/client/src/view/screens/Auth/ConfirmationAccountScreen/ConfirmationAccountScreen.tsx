...
import {
	CONFIRMATION_ACCOUNT_FORM_DEFAULT_VALUES,
	ConfirmationAccountFormSchema,
	type ConfirmationAccountFormSchemaTypes,
} from "./ConfirmationAccountFormSchema";

export function ConfirmationAccountScreen() {
	// TO-DO: CRIAR HOOK PARA ESTA SCREEN

	const form = useForm<ConfirmationAccountFormSchemaTypes>({
		resolver: zodResolver(ConfirmationAccountFormSchema),
		defaultValues: CONFIRMATION_ACCOUNT_FORM_DEFAULT_VALUES,
	});

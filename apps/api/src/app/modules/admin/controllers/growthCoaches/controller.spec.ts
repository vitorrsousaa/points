...
import type { IGetAllCoachesService } from "../../services/getAllCoaches";
import { GrowthCoachesController } from "./controller";

describe("Controller: GrowthCoaches", () => {
	let mockRequest: IRequest;
	let controller: GrowthCoachesController;
	let mockedService: Mocked<IGetAllCoachesService>;
	...
	beforeEach(() => {
		...
		controller = new GrowthCoachesController(mockedService);
	});

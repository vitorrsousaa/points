...
describe("Service:GetAllAthletesService", () => {
	let service: IGetAllAthletesService;
	let mockedUserRepository: Mocked<IUserRepository>;
	const inputData: IGetAllAthletesInput = {
		period: 1,
		userId: "123",
	};
	...
	beforeEach(() => {
		...
		service = new GetAllAthletesService(mockedUserRepository);
	});
